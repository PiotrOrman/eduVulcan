...
from ._utils import get_encoded_path
from .credentials import ICredential
from .models import EnvelopeResponse
...
class HttpClient:
    ...
    # PATCHED for HA vendoring: upstream __aexit__ referenced non-existent
    # self._session; explicit close() added so the integration can release
    # the aiohttp session on config entry unload.
